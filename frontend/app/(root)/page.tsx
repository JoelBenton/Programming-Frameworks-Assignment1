...
export default function Home() {
    ...
    const loadedFlashcards: FlashcardType[] = flashcardSets.map(
        (flashcard) => ({
            ...flashcard,
                        ...
                        <div>
                            <div className="flex flex-row w-full justify-between items-center">
                                ...
                                <button
                                    onClick={() => {
                                        router.push(
                                            `/flashcards/${selectedFlashcard.id}`,
                                        );
                                    }}
                            ...
                            <p className="text-lg font-normal mb-2 text-gray-500">
                                Created -{" "}
                                {selectedFlashcard.created_at.toLocaleString()}
                            </p>
                            <p className="text-lg font-normal mb-2 text-gray-500">
                                Last updated -{" "}
                                {selectedFlashcard.updated_at.toLocaleString()}
                            </p>
