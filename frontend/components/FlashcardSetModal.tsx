...
const FlashcardSetModal: React.FC<ModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60">
            <div className="relative w-full max-w-md max-h-[90vh] bg-gradient-to-br from-[#1c1c4d] to-[#7b5eb3] text-white rounded-xl shadow-xl overflow-auto">
                ...
                <div className="p-4 border-t border-white/10">
                    <button
                        className="w-full px-4 py-2 bg-red-500 text-white rounded-xl hover:bg-red-600 transition duration-200"
                        onClick={onClose}
                    >
                        Close
                    </button>
