...
const Sidebar = ({
    ...
    return (
        <div className="flex flex-col h-screen">
            <div
                className={`${open ? "w-60" : "w-20"} bg-background h-full p-5 pt-8 relative transition-all duration-500 ease-in-out flex flex-col justify-between`}
            >
                <div>
                  ...
                  ${currentPage === Menu.title ? "bg-gray-700 rounded-xl !text-[#a8b1ff]" : "hover:bg-gray-500 hover:rounded-xl "}`}
                                    onClick={() =>
                                        handleMenuClick(Menu.path[0])
                                    }
                                >
                                    <Icon name={Menu.icon} />
                                    <span
                                        className={`${!isVisible ? "hidden" : ""} transition-transform duration-200 origin-left`}
                                    >
                                        {Menu.title}
                                    </span>
                                </li>
